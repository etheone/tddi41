...
def testPingInternalHost():
    ...
    child = pexpect.spawn('ping client-1.d3.sysinst.ida.liu.se')
    print("Return status:")
...
def testDigInternalHost():
    ...
    print("               1: Test failed")
    print("Pass criteria: Internal network reachable through own nameserver.")
    child = pexpect.spawn('dig client-1.d3.sysinst.ida.liu.se')
    print("Return status:")
...
def testDigXInternalHost():
    ...
    child = pexpect.spawn('dig -x 130.236.179.83')
    print("Return status:")
    print(child.expect(["client-1.d3.sysinst.ida.liu.se", pexpect.EOF]))
    print(child.expect(["server.d3.sysinst.ida.liu.se", pexpect.EOF]))
    print("Test done.\n\n")
